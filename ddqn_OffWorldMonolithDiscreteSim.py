...
env = gym.make('OffWorldDockerMonolithDiscreteSim-v0', channel_type=Channels.DEPTH_ONLY) # CHANGE CAMERA TYPE FOR EXPERIMENT 1
env.seed(123)
...
def train():
    ...
    if os.path.exists("%s" % STATE_PATH):
        ...
        os.makedirs(STATE_PATH)DQMonolithDiscreteSim.
    ...
    max_eps = 0.8 #CHANGE FOR EXPERIMENT 2
    min_eps = 0.1
    learning_warmup_nb_steps = 50
    target_model_update = 1e-2
    learning_rate = 0.01 #CHANGE FOR EXPERIMENT 3
